            ...
            <div class="footer-region">
                <div class="footer-item footer-item-jc-init">
                    <div class="language">
                        ...
                        <div class="language-title">简体中文</div>
                    </div>
                    <div class="language-slide display-none">
                        <div class="language-slide-grid">
                            <div class="language-grid-item" data-language="cn">
                                <div class="language-content">简体中文</div>
                            </div>
                            <div class="language-grid-item" data-language="tw">
                                <div class="language-content">繁體中文</div>
                            </div>
                            <div class="language-grid-item" data-language="ru">
                                <div class="language-content">Русский</div>
                            </div>
                            <div class="language-grid-item" data-language="us">
                                <div class="language-content">English</div>
                            </div>
                        </div>
                    </div>
                </div>
